...
export class RequestsComponent implements OnInit {
  ...
  salvarEdicao() {
    ...
    if ((this.selecionado.funcionarioDestino !== this.selecionado.funcionario) ||
      ...
      this.selecionado.estado = this.funcionarioDestino === '' ? 'REDIRECIONADA' : 'APROVADA';
  ...
  irParaOrcamento(solicitacao: Employee): void {
    this.router.navigate(['/funcionario/orcamentos']);
  }
